...
class SoalUjian(models.Model):
    ...
    jawaban_1   = models.TextField(null=True)
    jawaban_2 = models.TextField(null=True)
    jawaban_3 = models.TextField()
    jawaban_4 = models.TextField()
    jawaban_5 = models.TextField(blank=True,null=True)
    jawaban_6 = models.TextField(blank=True,null=True)
    jawaban_7 = models.TextField(blank=True,null=True)
    pilih_jawaban_benar = models.CharField(choices=choices,)
