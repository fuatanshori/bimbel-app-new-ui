...
class SoalUjian(models.Model):
    ...
    jawaban_1   = CKEditor5Field('jawaban_1', config_name='extends',null=True)
    jawaban_2   = CKEditor5Field('jawaban_2', config_name='extends',null=True)
    jawaban_3   = CKEditor5Field('jawaban_3', config_name='extends',null=True)
    jawaban_4   = CKEditor5Field('jawaban_4', config_name='extends',null=True)
